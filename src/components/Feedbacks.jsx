    ...
    <div className='mt-0'>
      ...
      <div className='mt-7 flex justify-between items-center gap-1'>
        <div className='flex-1 flex flex-col'>
          <p className='text-green-400 font-medium text-[18px] italic'>
            <span className='blue-text-gradient'>@</span> {name}
          </p>
          <p className='mt-1 text-red-500   uppercase text-[16px]'>
    ...
    <div className={`mt-12 bg-black-200 rounded-[20px]`}>
      ...
      >
        <motion.div variants={textVariant()}>
          ...
          <h3 className={`${styles.sectionHeadText} text-gradient`}>Testimonials.</h3>
        </motion.div>
      </div>
