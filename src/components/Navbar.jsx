      ...
      <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
        ...
        >
          ...
          <p className={`${isReaderMode ? "text-gray-900" : "text-white"} uppercase text-[18px] font-bold cursor-pointer flex`}>
            Suneel &nbsp;
            <span className={`sm:block hidden ${isReaderMode ? "text-black opacity-80" : "text-white"}`}> | Computer Engineer</span>
          </p>
        </Link>
          ...
          {currentLinks.map((nav) => {
              ...
              return (
                <li key={nav.id} className="cursor-pointer">
                  <a
                    ...
                    className={`px-5 py-2 rounded-full text-[16px] font-semibold transition-all duration-300 ${
                      isReaderMode
            ...
            return (
              <li
                key={nav.id}
                className={`${
                  isReaderMode ? 'text-black opacity-80 hover:opacity-100' : 'text-white opacity-90 hover:opacity-100'
                } ${
